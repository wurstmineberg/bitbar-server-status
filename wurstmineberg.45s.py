...
if CONFIG.get('versionLink', True) is True:
    print('Version: {ver}|href=https://minecraft.gamepedia.com/{ver}'.format(ver=status['version']))
elif CONFIG.get('versionLink', True) == 'alt':
    print('Version: {ver}'.format(ver=status['version']))
    print('Version: {ver}|alternate=true href=https://minecraft.gamepedia.com/{ver}'.format(ver=status['version']))
else:
    print('Version: {ver}'.format(ver=status['version']))
if not status['running']:
